...
var getUrlParts = function( url ) {
	...
	wb = {
		...
		// VÃ©rifier si l'Ã©lÃ©ment <details> est supportÃ© nativement.
...
* 	{bolean} useFullBlock - if true, it will replace the scrubbed characters with the "â–ˆ" symbol;
...
* returns true
*
* wb.findPotentialPII( "email:test@test.com, phone:123 123 1234", { email:1 }{ replaceWith: [REDACTED/CAVIARDÃ‰] } )
* returns "email:[REDACTED/CAVIARDÃ‰], phone:123 123 1234"
*
* wb.findPotentialPII( "email:test@test.com, phone:123 123 1234, numÃ©ro de cas 12345678", { "customCase":/\b(?:case[\s-]?number[\s\-\\.]?(?:\d{5,10}))|(?:numÃ©ro[\s-]?de[\s-]?cas[\s\-\\.]?(?:\d{5,10}))/ig }, { useFullBlock:1})
* returns "phone:â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ, email:â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ, postalCode:â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ, â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ"
*/
wb.findPotentialPII = function( str, scope, opts ) {
	...
	for ( var valKey in validatedScope ) {
		...
		if ( arMatchedStr ) {
			isFound = true;
			if ( toClean ) {
				txtMarker = isFullBlock ? "â–ˆ".repeat( arMatchedStr[ 0 ].length ) : txtMarker;
...
var componentName = "wb-charts",
	...
	createCharts = function( $elm ) {
		 ...
		 * @param {number} refValue - Reference Value (DÃ©nominateur) of headerCell
		 */
...
var imgClass,
	...
	picturefill = function( elm ) {
		...
		for ( i = 0, len = sources.length; i !== len; i += 1 ) {
			...
			// VÃ©rifie si le media query correspond ou si aucun media query n'est dÃ©fini.
...
var componentName = "wb-exitscript",
	...
	i18nDict = {
		...
		fr: {
			...
			"exitMsg": "Vous Ãªtes sur le point de quitter un site sÃ©curisÃ©. Voulez-vous continuer?",
			"targetWarning": "Le lien s'ouvrira dans une nouvelle fenÃªtre de navigateur.",
			"yesBtn": "Oui",
			"cancelBtn": "Annuler"
						...
						complete: function() {
							...
							if ( wb.lang === "fr" ) {
								...
								$.validator.addMethod( "alphanumeric", function( value, element ) {
									return this.optional( element ) || /^[a-zÃ Ã¢Ã§Ã©Ã¨ÃªÃ«Ã®Ã¯Ã´Ã»Ã¹Ã¼Ã¿Ã¦Å“0-9_]+$/i.test( value );
